...
import com.cuijixu.seckill.backend.dao.Pay_orderMapper;
import com.cuijixu.seckill.backend.dao.SeckillMapper;
import com.cuijixu.seckill.backend.dao.cache.RedisDAO;
...
import com.cuijixu.seckill.backend.service.SeckillService;
...
//    private CuratorClientManager curatorClientManager;
    ...
    public List<Seckill> getSeckillList() {
        ...
        if (list == null || list.size()<1) {
            list = seckillMapper.queryAll(0, 10);
    ...
    public SeckillExecution updateInventory(long seckillId, long userPhone)
        ...
        try {
            ...
            int insertCount = pay_orderMapper.insertPayOrder(seckillId, userPhone, nowTime);
            ...
            if (insertCount <= 0) {
                ...
                Seckill currentSeckill = seckillMapper.queryById(seckillId);
